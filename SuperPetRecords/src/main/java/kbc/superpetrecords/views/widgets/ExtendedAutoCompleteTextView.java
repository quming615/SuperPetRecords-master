...
/**
 * Created by kellanbc on 7/17/14.
 */
public class ExtendedAutoCompleteTextView extends ExtendedEditText implements Filter.FilterListener {
    ...
    public static final int	simple_dropdown_hint = 17367127;
    ...
    private ExtendedAutoCompleteTextView.Validator mValidator = null;
    ...
    public ExtendedAutoCompleteTextView(Context context) {
        super(context, null);
        Log.d("ExtendedAutoCompleteTextView", "Consturctor: context, null");
    }

    public ExtendedAutoCompleteTextView(Context context, AttributeSet attrs) {
        super(context, attrs, Resources.getSystem().getIdentifier("autoCompleteTextViewStyle", "attr", "android"));
        Log.d("ExtendedAutoCompleteTextView", "Consturctor: context, attrs:" + attrs.toString());
        init(context, attrs, Resources.getSystem().getIdentifier("autoCompleteTextViewStyle", "attr", "android"));
    }

    public ExtendedAutoCompleteTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        Log.d("ExtendedAutoCompleteTextView", "Consturctor: context(" + attrs.toString() + "), defStyle(" + defStyle + ")");

        int popupViewStyle = Resources.getSystem().getIdentifier("listPopupWindow", "attr", "android");

        Log.d("ExtendedAutoCompleteTextView:", "Popup View: " + popupViewStyle);

        mPopup = new ListPopupWindow(context, attrs);
        mPopup.setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
        mPopup.setPromptPosition(ListPopupWindow.POSITION_PROMPT_BELOW);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ExtendedAutoCompleteTextView, defStyle, 0);
        mThreshold = a.getInt(R.styleable.ExtendedAutoCompleteTextView_completionThreshold, 2);

        Log.d("ExtendedAutoCompleteTextView:", "completionThreshold: " + mThreshold);

        mPopup.setListSelector(a.getDrawable(R.styleable.ExtendedAutoCompleteTextView_dropDownSelector));
        mPopup.setVerticalOffset((int)
            a.getDimension(R.styleable.ExtendedAutoCompleteTextView_dropDownVerticalOffset, 0.0f));
        mPopup.setHorizontalOffset((int)
            a.getDimension(R.styleable.ExtendedAutoCompleteTextView_dropDownHorizontalOffset, 0.0f));

        // Get the anchor's id now, but the view won't be ready, so wait to actually get the
        // view and store it in mDropDownAnchorView lazily in getDropDownAnchorView later.
        // Defaults to NO_ID, in which case the getDropDownAnchorView method will simply return
        // this TextView, as a default anchoring point.
        mDropDownAnchorId = a.getResourceId(R.styleable.ExtendedAutoCompleteTextView_dropDownAnchor,
            View.NO_ID);

        Log.d("ExtendedAutoCompleteTextView:", "dropDownAnchorId: " + mDropDownAnchorId);

        // For dropdown width, the developer can specify a specific width, or MATCH_PARENT
        // (for full screen width) or WRAP_CONTENT (to match the width of the anchored view).
        mPopup.setWidth(a.getLayoutDimension(
            R.styleable.ExtendedAutoCompleteTextView_dropDownWidth,
            ViewGroup.LayoutParams.WRAP_CONTENT));
        mPopup.setHeight(a.getLayoutDimension(
            R.styleable.ExtendedAutoCompleteTextView_dropDownHeight,
            ViewGroup.LayoutParams.WRAP_CONTENT));

        mHintResource = a.getResourceId(R.styleable.ExtendedAutoCompleteTextView_completionHintView,
            simple_dropdown_hint);

        mPopup.setOnItemClickListener(new DropDownItemClickListener());
        setCompletionHint(a.getText(R.styleable.ExtendedAutoCompleteTextView_completionHint));
        ...
        if (hint != null) {
            if (mHintView == null) {
                final TextView hintView = (TextView) LayoutInflater.from(getContext()).inflate(
                    mHintResource, null).findViewById(R.id.completionHintText);
    ...
    public <T extends ListAdapter & Filterable> void setAdapter(T adapter) {
        ...
        Log.d("ExtendedAutoCompleteTextView", "popup: " + mPopup);
    ...
    public void ensureImeVisible(boolean visible) {
        ...
        if (mFilter != null && enoughToFilter()) {
            showDropDown();
        }
    }
